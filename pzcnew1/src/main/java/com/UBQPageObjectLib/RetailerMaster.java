...
public class RetailerMaster extends WebDriverCommonLib {
	...
	// ---stateCombo---//
	@FindBy(how = How.XPATH, using = "//select[@name='stateCombo']")
	...
	//-- city--//
		@FindBy(how = How.XPATH, using = "//select[@name='cityCombo']")
	...
	// ---channel--//
		@FindBy(how = How.XPATH, using = "//select[@name='shopperChannel']")
	...
	public String ClickchannelarrowBtn() {
